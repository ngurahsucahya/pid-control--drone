...
roll_pid = PID(Kp=1.0, Ki=0.0, Kd=0.0)
pitch_pid = PID(Kp=1.0, Ki=0.0, Kd=0.0)
...
def set_attitude(roll_angle = 0.0, pitch_angle = 0.0,
    ...
    """
    roll_pid.setpoint = roll_angle  # Set the desired roll angle
    pitch_pid.setpoint = pitch_angle  # Set the desired pitch angle

    start_time = time.time()

    while time.time() - start_time < duration:
        roll_correction = roll_pid(roll_angle - vehicle.attitude.roll)
        pitch_correction = pitch_pid(pitch_angle - vehicle.attitude.pitch)

        send_attitude_target(
            roll_angle=roll_correction,
            pitch_angle=pitch_correction,
            yaw_angle=yaw_angle,
            yaw_rate=yaw_rate,
            use_yaw_rate=False,
            thrust=thrust
